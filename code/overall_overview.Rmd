...
growth <- read.table("growth files/growth.matrix", header = T)
...
bact_rel_growth <- ggplot(data=growth, aes(x=Time, y=bacteria, color=Manag, group=Manag)) +
    ...
    scale_color_manual(values=c("#1ABC9C", "#2980B9")) + theme_bw() + coord_cartesian(ylim=c(1,4)) +  ggtitle("a) Bacteria") +
...
ggsave("figures/bacterial_rel_growth.jpeg", width = 25, height = 15, units = "cm")
...
fungal_rel_growth <- ggplot(data=growth, aes(x=Time, y=fungi, group=Manag, color=Manag)) +
    ...
    geom_point(aes(color=Manag)) + xlab("Time point") + ylab("Relative growth rate") + labs(color="Land-use") + 
    scale_color_manual(values=c("#1ABC9C", "#2980B9")) + theme_bw() + coord_cartesian(ylim = c(1,4))+  ggtitle("b) Fungi") +
    theme(axis.text = element_text(size = 12)) + 
    theme(axis.title = element_text(size = 14)) +
    theme(legend.title = element_text(size = 14)) + 
    theme(legend.text = element_text(size = 14)) +
...
ggsave("figures/fungal_rel_growth.jpeg", width = 25, height = 15, units = "cm")

ggarrange(bact_rel_growth, fungal_rel_growth, labels = c("a)", "b)"), ncol = 2, common.legend = TRUE, legend = "right")
ggsave("figures/relative_growth_rate.jpeg", width = 35, height = 15, units = "cm")
...
captured_reads <- ggplot(read_counts, aes(x=Time, y=total_reads, fill=Manag.Straw)) + 
  geom_boxplot() + scale_fill_manual(values=c("#A3E4D7", "#1ABC9C", "#AED6F1", "#2980B9")) +
...
captured_reads <- captured_reads + theme(legend.position = "none")
ggsave("figures/captured_reads.jpeg", width = 30, height = 15, units = "cm")
...
ggsave("figures/rel_growth_and_reads_all.pdf", g, width = 35, height = 20, units = "cm")

ggarrange(bact_rel_growth, fungal_rel_growth, labels = c("a)", "b)"), ncol = 2, ggarrange(captured_reads, labels = "c)"), nrow = 2)
ggsave("figures/rel_growth_and_reads.jpeg", width = 35, height = 20, units = "cm")

ggarrange(bacteria_growth, fungi_growth, labels = c("a)", "b)"), ncol = 2, ggarrange(captured_reads, labels = "c)"), nrow = 2)
...
ggsave("figures/PCA_TMM.jpeg", width = 30, height = 20, units = "cm")
ggsave("figures/PCA_TMM.pdf", width = 30, height = 20, units = "cm")
...
ggsave("figures/PCA_TMM_envfit.jpeg", width = 35, height = 20, units = "cm")
ggsave("figures/PCA_TMM_envfit.pdf", width = 35, height = 20, units = "cm")
...
set.seed(5392)
perm1 <- adonis(All_TMM_stat ~ Manag+Straw+Manag:Straw, 
                   data=All_meta, permutations=999, strata = All_meta$Soils)
perm1

#permanova 2, time included
set.seed(5392)
perm2 <- adonis(All_TMM_stat ~ Manag+Straw+Time+Manag:Straw+Manag:Time+Straw:Time, 
                   data=All_meta, permutations=999, strata = All_meta$Soils)
perm2

write.csv(perm2$aov.tab, "results/func_permanova_all.csv")
...
my_colour = list(
  `Land-use + treatment` = c(GC = "#A3E4D7", GS = "#1ABC9C", WC = "#AED6F1", WS = "#2980B9"), 
...
ggsave("figures/merge_PCA.pdf", width = 60, height = 25, units = "cm")
...
ggsave("figures/PCA_grass.jpeg", width = 30, height = 20, units = "cm")
ggsave("figures/PCA_grass.pdf", width = 30, height = 20, units = "cm")
...
ggsave("figures/PCA_wheat.jpeg", width = 30, height = 20, units = "cm")
ggsave("figures/PCA_wheat.pdf", width = 30, height = 20, units = "cm")
...
### merge PCA grass, wheat
```{r merge PCA, message=FALSE, warning=FALSE}

ggarrange(PCA_grass, PCA_wheat, labels = c("a)", "b)"), ncol = 2, common.legend = FALSE, legend = "right", align = "hv", vjust = 2, hjust = -0.4)
ggsave("figures/PCA_grass_wheat.jpeg", width = 35, height = 18, units = "cm")
ggsave("figures/PCA_grass_wheat.pdf", width = 35, height = 18, units = "cm")
...
ggsave("figures/PCoA_TPM_taxa.jpeg", width = 30, height = 20, units = "cm")
ggsave("figures/PCoA_TPM_taxa.pdf", width = 30, height = 20, units = "cm")
...
#permanova 1
set.seed(5392)
permanova_tax1 <- adonis(bray_taxa ~ Manag+Straw+Manag:Straw, 
...
write.csv(res_signif,"results/DE_all_GS.csv",row.names=T)
...
write.csv(res_signif,"results/DE_all_WS.csv",row.names=T)
...
write.csv(res_signif,"results/DE_all_WvsG_C.csv",row.names=T)
...
write.csv(res_signif,"results/DE_all_WvsG_S.csv",row.names=T)
...
write.csv(res_signif,"results/DE_all_interaction.csv",row.names=T)
...
write.csv(res_signif,"results/DE_WS_T1.csv",row.names=T)
...
write.csv(res_signif,"results/DE_WS_T6.csv",row.names=T)
...
write.csv(res_signif,"results/DE_WS_T3.csv",row.names=T)
...
write.csv(res_signif,"results/DE_W_T6vsT3_C.csv",row.names=T)
...
write.csv(res_signif,"results/DE_W_T3vsT1_S.csv",row.names=T)
...
write.csv(res_signif,"results/DE_W_T6vsT1_S.csv",row.names=T)
...
write.csv(res_signif,"results/DE_W_T6vsT3_S.csv",row.names=T)
...
write.csv(res_signif,"results/DE_GS_T1.csv",row.names=T)
...
write.csv(res_signif,"results/DE_GS_T6.csv",row.names=T)
...
write.csv(res_signif,"results/DE_GS_T3.csv",row.names=T)
...
write.csv(res_signif,"results/DE_G_T6vsT3_C.csv",row.names=T)
...
write.csv(res_signif,"results/DE_G_T3vsT1_S.csv",row.names=T)
...
write.csv(res_signif,"results/DE_G_T6vsT1_S.csv",row.names=T)
...
write.csv(res_signif,"results/DE_G_T6vsT3_S.csv",row.names=T)
